...
- `Device (TCH0)` — Goodix GT9916S touch
- `Device (I2C0)`, `I2C1`, `I2C3` — I2C controllers
...
- Phase 2: `touch_ic`, `touch_i2c_addr`, `touch_reset_gpio`, `touch_irq_gpio`, `has_tfa9874`, `nfc_ic`, `power_key_gpio`, `vol_up_gpio`
- Phase 3: `imu_ic`, `magnetometer_ic`, `als_prox_ic` (new fields)
