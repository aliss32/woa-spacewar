...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    {"RAM Partition 2",   0x180000000, 0x80000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,  WRITE_BACK_XN}, /* Adjusted for 8GB total */
    /* DDR Bank 2 End */
    ...
    {"QUP",               0x00900000, 0x00200000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},      /* Corrected to DEVICE for UART */
    ...
    {"APSS_HM",           0x17800000, 0x00E00000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},     /* Corrected to DEVICE for GIC */
    
    /* Device Specific / Missing from generic sm7325 */
